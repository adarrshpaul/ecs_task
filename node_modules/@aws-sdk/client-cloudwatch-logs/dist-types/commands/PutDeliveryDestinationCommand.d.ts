 ...
 *
 */
export declare class PutDeliveryDestinationCommand extends $Command<PutDeliveryDestinationCommandInput, PutDeliveryDestinationCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: PutDeliveryDestinationCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: PutDeliveryDestinationCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<PutDeliveryDestinationCommandInput, PutDeliveryDestinationCommandOutput>;
    /**
     * @internal
     */
    private serialize;
