 ...
 *
 */
export declare class PutDeliverySourceCommand extends $Command<PutDeliverySourceCommandInput, PutDeliverySourceCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: PutDeliverySourceCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: PutDeliverySourceCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<PutDeliverySourceCommandInput, PutDeliverySourceCommandOutput>;
    /**
     * @internal
     */
    private serialize;
