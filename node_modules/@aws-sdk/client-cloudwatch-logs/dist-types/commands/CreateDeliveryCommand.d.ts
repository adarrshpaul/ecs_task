 ...
 *
 */
export declare class CreateDeliveryCommand extends $Command<CreateDeliveryCommandInput, CreateDeliveryCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: CreateDeliveryCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: CreateDeliveryCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<CreateDeliveryCommandInput, CreateDeliveryCommandOutput>;
    /**
     * @internal
     */
    private serialize;
