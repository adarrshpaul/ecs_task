 ...
 *
 */
export declare class DeleteDeliveryDestinationCommand extends $Command<DeleteDeliveryDestinationCommandInput, DeleteDeliveryDestinationCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: DeleteDeliveryDestinationCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: DeleteDeliveryDestinationCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DeleteDeliveryDestinationCommandInput, DeleteDeliveryDestinationCommandOutput>;
    /**
     * @internal
     */
    private serialize;
