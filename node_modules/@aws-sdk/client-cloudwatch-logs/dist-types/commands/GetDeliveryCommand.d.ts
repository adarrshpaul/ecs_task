 ...
 *
 */
export declare class GetDeliveryCommand extends $Command<GetDeliveryCommandInput, GetDeliveryCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: GetDeliveryCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: GetDeliveryCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<GetDeliveryCommandInput, GetDeliveryCommandOutput>;
    /**
     * @internal
     */
    private serialize;
