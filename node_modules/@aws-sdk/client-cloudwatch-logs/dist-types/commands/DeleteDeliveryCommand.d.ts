 ...
 *
 */
export declare class DeleteDeliveryCommand extends $Command<DeleteDeliveryCommandInput, DeleteDeliveryCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: DeleteDeliveryCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: DeleteDeliveryCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DeleteDeliveryCommandInput, DeleteDeliveryCommandOutput>;
    /**
     * @internal
     */
    private serialize;
