 ...
 *
 */
export declare class GetDeliverySourceCommand extends $Command<GetDeliverySourceCommandInput, GetDeliverySourceCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: GetDeliverySourceCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: GetDeliverySourceCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<GetDeliverySourceCommandInput, GetDeliverySourceCommandOutput>;
    /**
     * @internal
     */
    private serialize;
