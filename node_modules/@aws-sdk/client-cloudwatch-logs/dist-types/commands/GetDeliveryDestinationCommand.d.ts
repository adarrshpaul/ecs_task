 ...
 *
 */
export declare class GetDeliveryDestinationCommand extends $Command<GetDeliveryDestinationCommandInput, GetDeliveryDestinationCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: GetDeliveryDestinationCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: GetDeliveryDestinationCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<GetDeliveryDestinationCommandInput, GetDeliveryDestinationCommandOutput>;
    /**
     * @internal
     */
    private serialize;
