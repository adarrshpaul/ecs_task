 ...
 *
 */
export declare class DeleteDeliverySourceCommand extends $Command<DeleteDeliverySourceCommandInput, DeleteDeliverySourceCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: DeleteDeliverySourceCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: DeleteDeliverySourceCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DeleteDeliverySourceCommandInput, DeleteDeliverySourceCommandOutput>;
    /**
     * @internal
     */
    private serialize;
