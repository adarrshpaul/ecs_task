 ...
 *
 */
export declare class DescribeDeliverySourcesCommand extends $Command<DescribeDeliverySourcesCommandInput, DescribeDeliverySourcesCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: DescribeDeliverySourcesCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: DescribeDeliverySourcesCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DescribeDeliverySourcesCommandInput, DescribeDeliverySourcesCommandOutput>;
    /**
     * @internal
     */
    private serialize;
