 ...
 *
 */
export declare class PutDeliveryDestinationPolicyCommand extends $Command<PutDeliveryDestinationPolicyCommandInput, PutDeliveryDestinationPolicyCommandOutput, CloudWatchLogsClientResolvedConfig> {
    readonly input: PutDeliveryDestinationPolicyCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: PutDeliveryDestinationPolicyCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: CloudWatchLogsClientResolvedConfig, options?: __HttpHandlerOptions): Handler<PutDeliveryDestinationPolicyCommandInput, PutDeliveryDestinationPolicyCommandOutput>;
    /**
     * @internal
     */
    private serialize;
